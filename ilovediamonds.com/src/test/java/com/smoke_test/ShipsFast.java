...
public class ShipsFast extends BaseTest {
	...
	public Object[][] getData() {
		...
		String s[][] = utility.getDataFromCSV(workingdirectory + "\\products.csv", colNameToLocation);// from utility file it get the total no of data through the object and store it in s
		String random[][] = null;
		...
		return random;// here it stores the no of input from the testsuite file i.e the user input

	}

	/**
	 * This function is used to test the mapping values from product detail page with csv file
	 * 
	 * @param Sting
	...
	public void testCSVData(String Sku, String Product, String DiaAmountSIGH, String DiaAmountVVSEF,
		...
		driver.findElement(By.xpath("//div[@id='ajax_register_close']")).click();//popup close
        driver.findElement(By.xpath("//div[@class='search_outer']//img")).click();// for search option click
        Thread.sleep(3000);
		WebElement elem = driver.findElement(By.xpath("//*[@id='ild_search_box']//form//div//input[@id='search']"));// click image
		elem.sendKeys(Sku);
		elem.sendKeys("\n");
		...
		Assert.assertTrue(e.isEnabled());//return true when the buynow button enable
		...
		// Verification of Diamond price SIGH
			 ...
			 */
			verifyProductDetailAttribute(totalGemAmount, MetalType, height, width, MetalWeight, Catagory, TypeOfProduct,
	...
	public void verifyProductDetailAttribute(String totalGemAmount, String MetalType, String height, String width,
