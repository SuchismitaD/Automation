...
public class CSVAddtoShortlist extends BaseTest {
        ...
        //shortlist from catagory page
          WebElement b1 = driver.findElement(By.xpath("//div[@id='fme_layered_container']/div[1]/div[3]/ul/li/div/div/a[1]/img"));
    	     b1.click();
    	    Thread.sleep(2000);
    	    driver.findElement(By.xpath("//html/body/div[3]/div/div[1]/div/div[2]/div[2]/ul/li[2]/div/a/span")).click();
          if(driver.findElements(By.xpath("//html/body/div[3]/div/div[3]/div/div[3]/div/div[2]/div/div/div[1]/div/h1")).size() != 0){
      	 ...
      	 Shortlist2="<font color=red>" + "Not Added to shortlist from product detail page" + "</font>";
      	    ...
      	    driver.findElement(By.xpath("//button[@class='button'][@title='Share Shortlist']")).click();
                    ...
                    // verifyProductDetailAttribute(sku, name );
                     createHtML("PASS", sku, name, ZoomIcon, Thumbnail1,Thumbnail2,Thumbnail3,Thumbnail4,Thumbnail5,Shortlist1,Shortlist2);
                }
                ...
                htmlReport = "<!DOCTYPE html><html><head><p>Hi All,</p>"
                            ...
                            "<th>Thumbnail4</th>" +"<th>Thumbnail5</th>" + "<th>Shortlist1</th>" + "<th>Shortlist2</th>" + "</tr>";
                          }
                ...
                public void createHtML(String result, String sku, String name, String ZoomIcon,String Thumbnail1,
                                       ...
                                       String Shortlist1,String Shortlist2) 
                {
                              
                     String result1 = "PASS";
                     
                 htmlReport = htmlReport + "<tr>" + "<td>" + result1 + "</td>" + "<td>" + sku + "</td>" + "<td>" + name + "</td>"+
                  "<td>" + ZoomIcon + " </td>" +"<td>" + Thumbnail1 + "</td>"+"<td>" + Thumbnail2 + "</td>"+
                   "<td>" + Thumbnail3 + "</td>"+"<td>" + Thumbnail4 + "</td>"+"<td>" + Thumbnail5 + "</td>"+
                   "<td>" + Shortlist1 + "</td>"+"<td>" + Shortlist2 + "</td>"+"</tr>";
                                finalResult = null;
                }
}
